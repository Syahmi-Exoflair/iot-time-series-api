...
Route::get('/readings/calculate-monthly-power', [App\Http\Controllers\ReadingController::class, 'calculateMonthlyPowerUsage'])->middleware('auth:sanctum');
...
Route::get('/readings/minmax-people-counter', [App\Http\Controllers\ReadingController::class, 'getPeopleCounterReading'])->middleware('auth:sanctum');